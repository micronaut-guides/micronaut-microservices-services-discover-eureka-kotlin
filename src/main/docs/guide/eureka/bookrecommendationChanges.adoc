...
include::{sourceDir}/bookrecommendation/src/main/kotlin/example/micronaut/bookrecommendation/BookCatalogueClient.kt[tag=eureka]
...
include::{sourceDir}/bookrecommendation/src/main/kotlin/example/micronaut/bookrecommendation/BookInventoryClient.kt[tag=eureka]
